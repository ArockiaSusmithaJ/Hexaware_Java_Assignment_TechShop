...
public class Main {
    private static final String URL = "jdbc:mysql://localhost:3306/techshop"; // Update with your database name
    private static final String USER = "root"; // Update with your database username
    private static final String PASSWORD = "Susmi@833"; // Update with your database password
